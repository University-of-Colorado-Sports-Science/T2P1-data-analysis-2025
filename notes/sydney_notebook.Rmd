...
table(filter_full3$HSI)
prop.table(table(filter_full3$HSI))
```
...
mean(filter_full3$Nordic.MEAN.Imbalance.with.side)
mean(filter_full3$Percent.Difference.Norm)

#convert from character to numeric
filter_full3$Time.Injured <- as.numeric(filter_full3$Time.Injured)
mean(filter_full3$Time.Injured)
```
