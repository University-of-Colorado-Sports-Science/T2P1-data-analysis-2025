...
mean(final_merge_full$Nordic.MEAN.Imbalance.with.side)
mean(final_merge_full$Maximum.Force)
mean(final_merge_full$Nordic.Right.MAX)
mean(final_merge_full$Nordic.Left.MAX)
mean(final_merge_full$Overall.Wellness.Score)
...
table(filter_full3_merge$HSI, filter_full3_merge$Status)
```
...
rf_model <- randomForest(as.factor(HSI)~., data=filter_full3_merge, ntree=500, importance=TRUE)
varlmpPlot(rf)
...
##Multimetric Matrix- goal to create a risk score by counting how many thresholds an athlete breaches 
